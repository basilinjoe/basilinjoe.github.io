...
<figure>
<svg role="img" aria-labelledby="chart1-title chart1-desc" viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: '100%', height: 'auto', background: '#0f172a' }}>
  ...
  <style>{`
    .lbl{font:14px system-ui,-apple-system,sans-serif;fill:#e5e7eb}
    .val{font:600 14px system-ui,-apple-system,sans-serif;fill:#f9fafb}
    .cap{font:12px system-ui,-apple-system,sans-serif;fill:#9ca3af}
    .axis{font:11px system-ui,-apple-system,sans-serif;fill:#9ca3af}
  `}</style>
  <text x="20" y="30" className="lbl" style={{ fontSize: '16px', fontWeight: 600 }}>Tokens consumed per workflow</text>
  <text x="20" y="50" className="cap">Google Drive → Salesforce example, Anthropic Engineering (Nov 2025)</text>

  <text x="20" y="100" className="lbl">Naive tool loading</text>
  <rect x="180" y="82" width="420" height="26" fill="#ef4444" rx="3" />
  <text x="608" y="100" className="val" textAnchor="end">~150,000</text>

  <text x="20" y="160" className="lbl">Code execution</text>
  <rect x="180" y="142" width="6" height="26" fill="#22c55e" rx="3" />
  <text x="196" y="160" className="val">~2,000</text>

  <text x="180" y="210" className="axis">0</text>
  <text x="600" y="210" className="axis" textAnchor="end">160,000 tokens</text>
  <line x1="180" y1="200" x2="600" y2="200" stroke="#374151" strokeWidth="1" />

  <text x="20" y="270" className="cap">~98.7% reduction. Source: anthropic.com/engineering/code-execution-with-mcp</text>
</svg>
...
<figure>
<svg role="img" aria-labelledby="chart2-title chart2-desc" viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: '100%', height: 'auto', background: '#0f172a' }}>
  ...
  <style>{`
    .lbl{font:12px system-ui,-apple-system,sans-serif;fill:#e5e7eb}
    .cap{font:11px system-ui,-apple-system,sans-serif;fill:#9ca3af}
    .title{font:600 15px system-ui,-apple-system,sans-serif;fill:#f9fafb}
  `}</style>
  <text x="20" y="26" className="title">MCP adoption milestones</text>
  <text x="20" y="44" className="cap">Nov 2024 – Nov 2025. Sources: vendor blogs (see article).</text>
  ...
  <text x="40" y="230" className="lbl" textAnchor="middle">Nov '24</text>
  <text x="160" y="230" className="lbl" textAnchor="middle">Mar '25</text>
  <text x="280" y="230" className="lbl" textAnchor="middle">Apr '25</text>
  <text x="420" y="230" className="lbl" textAnchor="middle">May '25</text>
  <text x="540" y="230" className="lbl" textAnchor="middle">Nov '25</text>

  <text x="40" y="255" className="cap" textAnchor="middle">Anthropic launches MCP</text>
  <text x="160" y="255" className="cap" textAnchor="middle">OpenAI adopts</text>
  <text x="280" y="255" className="cap" textAnchor="middle">Google DeepMind</text>
  <text x="420" y="255" className="cap" textAnchor="middle">Microsoft GA</text>
  <text x="540" y="255" className="cap" textAnchor="middle">Code-execution</text>
  <text x="540" y="270" className="cap" textAnchor="middle">guidance</text>

  <text x="40" y="295" className="cap" textAnchor="middle">initial partners</text>
  <text x="160" y="295" className="cap" textAnchor="middle">Agents SDK</text>
  <text x="280" y="295" className="cap" textAnchor="middle">Gemini SDK</text>
  <text x="420" y="295" className="cap" textAnchor="middle">Copilot Studio</text>
</svg>
